...
public class WireHandler {
	...
	/**
	 * Retrieve the {@link net.dutymod.server.wire.Node Node} that represents the
	...
	/**
	 * Remove and return the {@link net.dutymod.server.wire.Node Node} at the given
	 * position.
	 */
	 ...
	 * wire, then create a new {@link net.dutymod.server.wire.WireNode WireNode}.
	 * Otherwise, grab the next {@link net.dutymod.server.wire.Node Node} from the
	 * cache and update it.
	 */
