...
import net.dutymod.server.mixin.biome.MultiNoiseBiomeSourceAccessor;
...
public class BiomeFinder {
    public static Pair<BlockPos, Holder<Biome>> findClosestBiome3d(@NotNull BlockPos pos, int radius, int horizontalStep,
        ...
        int[] heights = Mth.outFromOrigin(pos.getY(), level.getMinBuildHeight() + 1, level.getMaxBuildHeight() + 1, verticalStep).toArray();
