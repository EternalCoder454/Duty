package net.dutymod.fixerupper.common.mixin.bugfix.sprite_borders;
...
public class GuiMixin {
    ...
    @ModifyArg(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/client/gui/GuiGraphicsExtractor;blitSprite(Lcom/mojang/blaze3d/pipeline/RenderPipeline;Lnet/minecraft/resources/ResourceLocation;IIIIIIII)V"
            ),
            index = 8
    )
