...
public class FixerUpperMixinPlugin implements IMixinConfigPlugin {
    ...
    public void postApply(String targetClassName, ClassNode targetClass, String mixinClassName, IMixinInfo mixinInfo) {
        if(mixinClassName.equals("net.dutymod.fixerupper.common.mixin.perf.reduce_blockstate_cache_rebuilds.BlockStateBaseMixin")) {
            try {
                applyBlockStateCacheScan(targetClass);
            } catch(RuntimeException e) {
                FixerUpperMixinPlugin.instance.logger.error("Applying blockstate cache ASM patch failed", e);
            }
        }
    ...
    private void applyBlockStateCacheScan(ClassNode targetClass) {
        ...
        injectorMethodNames.forEach((name, method) -> {
            ...
            if(needInjection) {
                FixerUpperMixinPlugin.instance.logger.info("Injecting BlockStateBase cache population hook into {} from {}",
