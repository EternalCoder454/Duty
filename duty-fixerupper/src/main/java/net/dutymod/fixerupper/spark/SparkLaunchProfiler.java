...
/**
 * Stub for FixerUpper's spark launch profiler.
 *
 ...
 * {@code FixerUpperClient} and the platform hooks, the class keeps its shape and does nothing.
 *
 ...
 * take the real implementation from FixerUpper upstream.
 */
