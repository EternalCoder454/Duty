package net.dutymod.fixerupper.platform.neoforge;
...
import net.dutymod.fixerupper.util.CommonModUtil;
...
public class FixerUpperPlatformHooksImpl implements FixerUpperPlatformHooks {
    ...
    FixerUpperMixinPlugin.class.getPackage().getImplementationVersion())
    .orElse("[unknown]");
    ...
    public void injectPlatformSpecificHacks() {
        ...
        if(FixerUpperMixinPlugin.instance.isOptionEnabled("feature.spark_profile_launch.OnForge")) {
            CommonModUtil.runWithoutCrash(() -> SparkLaunchProfiler.start("launch"), "Failed to start profiler");
        }

        if(FixerUpperMixinPlugin.instance.isOptionEnabled("feature.log_stdout_in_log_files.PrintStreamReplacement")) {
    ...
    public void onLaunchComplete() {
        ...
        FixerUpperForge.launchDone = true;
    }
