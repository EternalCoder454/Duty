...
public class GuiMixin {
    ...
    private void gnetum$wrapRenderDebugOverlay(Hud hud, GuiGraphicsExtractor guiGraphics, Operation<Void> original) {
        if (this.minecraft.isGameLoadFinished() && (!this.minecraft.gui.hud.isHidden() || this.minecraft.gui.screen() != null)) {
            ...
            if (debug.shouldRender()) {
                ...
                original.call(hud, StatefulHudHandler.alternativeGuiGraphicsExtractor);
