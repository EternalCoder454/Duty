package net.dutymod.client.obe.config;
...
import net.dutymod.client.obe.platform.PlatformHelper;
...
public class SettingsManager {
    ...
    /**
     * Kept as its own JSON file rather than folded into duty.properties.
     *
     * <p>These 32 options span booleans, enums, floats and ints, and several are per-block-entity
     * render modes. Flattening that onto the properties file would either lose the types or bloat
     * the format for one feature's benefit. The master switch that turns the whole feature on and
    ...
    private static Map<String, String> loadSettings() {
        try (Reader reader = Files.newBufferedReader(CONFIG_PATH)) {
            ...
            OBE.LOGGER.info("[Duty] Block entity config not found or invalid; using defaults.");
            return new HashMap<>();
        }
    }
