...
import net.dutymod.client.mixin.hudcache.GameRendererAccessor;
...
import net.dutymod.client.mixin.hudcache.MinecraftAccessor;
//? }
//? >=1.21.10 {
...
public class VersionCompatUtil {
	...
	public static void flush(GuiGraphicsExtractor guiGraphics) {
		//? >=26.2 {
