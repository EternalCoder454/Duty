package net.dutymod.client.hudcache.compat.xaerominimap;
...
public class XaeroMinimapCompat {
	...
	public static void tryRenderWaypoint(GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
		runSafely(() -> {
